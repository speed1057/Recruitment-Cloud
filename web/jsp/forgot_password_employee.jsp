...
<body>
   ...
   <%
       ...
       if(!deo.isvalidEmailandAnswer(id, answer))
       {
                   ...
                   <nav>
                    ...
                    <div class="collapse navbar-collapse" id="myNavbar">
                      <ul class="nav navbar-nav">
                          <li class="btn-warning active"><a href="<%=request.getContextPath()%>/jsp/employee_login.jsp">Home</a></li>
                      </ul>
                      ...
                      <ul class="nav navbar-nav navbar-right">
                        <li class="dropdown">
                            <a class="btn-warning" href="<%=request.getContextPath()%>/jsp/employee_login.jsp">LogIn</a>
                        </li>   
                      </ul>
                    </div>
                 </nav>
    ...
    <div class="wrapper-content">
                <div class="panel panel-info" style="width:50%; height: 60%; margin: 10% 25%;">
                    ...
                    <div class="panel-body">
                        <form id="signupform" class="form-horizontal" role="form" onsubmit="return validate()" action="jsp_servlet/change_emp_password.jsp">                     
