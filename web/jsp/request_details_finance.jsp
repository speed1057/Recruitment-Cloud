                                           ...
                                           <tr><td>Required Post :</td><td><%= r.getRequired_post() %></td></tr>
                                            <tr><td>Post Duration :</td><td><%= r.getPosition_duration() %></td></tr>
                                             <tr><td>Existing Employee :</td><td><%= r.getExisting_emp() %></td></tr>
                                              ...
                                              <tr><td><a href="jsp_servlet/validate_request.jsp?status=y&id=<%= r.getReq_id() %>" class="btn btn-info" >Approve</a></td><td><a href="jsp_servlet/validate_request.jsp?status=n&id=<%= r.getReq_id() %>" class="btn btn-danger" >Reject</a></td></tr>
