...
<html lang="en">
    ...
    <body>
                   ...
                   <nav>
                    ...
                    <div class="collapse navbar-collapse" id="myNavbar">
                      ...
                      <ul class="nav navbar-nav navbar-right">
                        <li>
                            <a class="btn-warning" href="candidate_login.jsp">Log In</a>
                        </li>   
                      </ul>
                    </div>
                 </nav>
     ...
     <div class="wrapper-content">
         <center>
         <h1 style="margin-top: 3%;margin-bottom: 3%; font-size: 400%;">You Have Been Successfully Logged Out!!</h1>
         <img class="img-responsive" src="../image/candidate_logout.png" />
         </center> 
     </div>
